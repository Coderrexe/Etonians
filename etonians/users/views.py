...
from etonians.users.forms import (RegistrationForm, VerifyEmailForm, LoginForm, UpdateAccountForm,
                                  UpdateAccountPasswordForm, RequestResetForm, ResetPasswordForm)
...
def login():
    ...
    if login_form.validate_on_submit():
        ...
        # compares the hashed password stored in the database with the password the user enters
        ...
        for verification_code in verification_code_list:
            if form.verification_code.data == verification_code.value:
                ...
                user = User(
                    ...
                    year_group=user_info.year_group
                )
